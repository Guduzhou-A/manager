  ...
  <body>
    ...
    <div class="page text-center">
      ...
      <header class="page-header">
                ...
                <ul class="rd-navbar-nav">
                    ...
                    <li><a href="products_portfolio.html">PRODUCTS</a>
                      ...
                      <ul class="rd-navbar-dropdown">
                        ...
                        <li><a href="cloudcore2.html">Cloud Core EPC</a></li>
                        <li><a href="cloudcore.html">Cloud Core OMC</a></li>
                      </ul>
                    </li>
  
                    <li class="active"><a href="media_show.html">Media</a>
                      <!-- RD Navbar Dropdown-->
                      <!-- <ul class="rd-navbar-dropdown">
        ...
        <section class="context-dark" style="margin-top: -80px;">
          ...
          <div data-on="false" data-md-on="true" class="rd-parallax">
            <div data-speed="0.25" data-type="media" data-url="images/new-img/media-text-banner.png" class="rd-parallax-layer"></div>
              ...
              <div class="">
                <div class="shell section-34 section-md-100 section-lg-top-170 section-lg-bottom-165">
                  ...
                  <div class="offset-top-4">
                    <h6 style="text-align: left;"><span style="font-size: 36px;">MEDIA</span></h6>
                  </div>
                </div>
              </div>
            </div>
      ...
      <main>
        <!-- About Us-->
            <#--<div>-->
                <#--<img src="images/detaile5.png" alt="" width="100%">-->
            <#--</div>-->
          ${(data.content)!}
      </main>
