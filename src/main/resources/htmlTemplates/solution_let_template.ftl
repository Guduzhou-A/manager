  ...
  <body>
    ...
    <div class="page text-center">
      ...
      <header class="page-header">
            ...
            <div class="rd-navbar-inner">
              ...
              <div class="rd-navbar-nav-wrap">
                ...
                <ul class="rd-navbar-nav">
                    ...
                    <li class="active"><a href="baicells_technologies.html">LTE/LTE-A</a>
                      <!-- RD Navbar Dropdown-->
                      <ul class="rd-navbar-dropdown">
        ...
        <section class="context-dark" style="margin-top: -80px;">
          ...
          <div data-on="false" data-md-on="true" class="rd-parallax">
            <div data-speed="0.25" data-type="media" data-url="${(data.bgPicUrl)!}" class="rd-parallax-layer"></div>
              ...
              <div class="">
                <div class="shell section-34 section-md-100 section-lg-top-170 section-lg-bottom-165">
                  ...
                  <div class="offset-top-4">
                    <h6 style="text-align: left;"><span style="font-size: 24px;">LTE/LTE-A</span> <br/> <span style="font-size: 36px;">${(data.title)!}</span></h6>
                  </div>
                </div>
              </div>
            </div>
      ...
      <main class="page-content">
        <!-- About Us-->
        <section class="section-80 text-left" style="padding-bottom: 0;">
          <div class="shell">
            <!-- Box-->
            <div class="bg-white reveal-block text-silver-chalice text-small">
                ${(data.content)!}
            </div>
          </div>
        </section>
